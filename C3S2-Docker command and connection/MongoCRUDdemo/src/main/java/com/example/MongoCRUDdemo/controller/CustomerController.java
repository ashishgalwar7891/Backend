...
public class CustomerController {
    ...
    //http://localhost:8082/api/customer/v1/addCust
    @PostMapping("/addCust")
    ...
    //http://localhost:8082/api/customer/v1/getCusts
    @GetMapping("/getCusts")
    ...
    //http://localhost:8082/api/customer/v1/delCust/XXX
    ...
    //http://localhost:8082/api/customer/v1/upCust
    @PutMapping("/upCust")
    ...
    //http://localhost:8082/api/customer/v1/getOneCust/XXX
    ...
    //http://localhost:8082/api/customer/v1/getCustByCity/XXX
