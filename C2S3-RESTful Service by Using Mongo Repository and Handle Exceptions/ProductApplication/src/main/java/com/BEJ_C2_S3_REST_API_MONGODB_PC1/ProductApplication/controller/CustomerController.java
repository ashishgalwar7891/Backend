package com.BEJ_C2_S3_REST_API_MONGODB_PC1.ProductApplication.controller;
...
import com.BEJ_C2_S3_REST_API_MONGODB_PC1.ProductApplication.services.CustomerServices;
...
public class CustomerController {
    ...
    {
        return new ResponseEntity<>(customerServices.getCustomer(), HttpStatus.OK);
    }
    ...
    {
        return new ResponseEntity<>(customerServices.deleteCustomer(cid),HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getProductByProductName(@PathVariable String pn) {
        return new ResponseEntity<>(customerServices.getProductByProductName(pn),HttpStatus.OK);
    }
}
